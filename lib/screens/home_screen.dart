...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static const sessionCooldownDuration =
      Duration(seconds: 10); // مثال: ساعة واحدة
  ...
  Future<void> _loadTokenAndInitialData() async {
    ...
    try {
      ...
      debugPrint(
          "HomeScreen: Load finished. Loading: $_isLoading, ErrorMsg: $_errorMessage, SessionAvailable: $isSessionAvailable, CoolingDown: $isSessionInProgressOrCoolingDown, FetchingGroup: $_isFetchingTestGroup");
    }
  }
  ...
  Future<void> _fetchNextSessionDataFromApi() async {
    ...
    if (!_isLoading && !_isFetchingTestGroup)
      setStateIfMounted(() => _isLoading = true);
    try {
      ...
      if (_nextSessionData != null) {
        ...
        await _checkAndGenerateTestNotificationsBasedOnSessionObject(
            _nextSessionData!); // <--- الاستدعاء هنا
  ...
  Future<void> _startThreeMonthTest() async {
    ...
    try {
      ...
      if (testGroupData != null && testGroupData.sessions.isNotEmpty) {
        ...
        if (mounted)
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text("لا يوجد اختبار 3 شهور متاح حاليًا.",
                  textDirection: TextDirection.rtl)));
      }
    } catch (e) {
                                        ...
                                        Expanded(
                                            ...
                                            child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                      (isSessionAvailable &&
                                                              ...
                                                              _nextSessionData!
                                                                      .typeId !=
                                                                  99)
                                                          ? 'حان وقت الجلسة${_nextSessionData!.title != null && _nextSessionData!.title!.isNotEmpty ? " (${_nextSessionData!.title})" : "!"}'
                                                          : (_errorMessage !=
                                                                      null &&
                                                                  (_errorMessage!
                                                                          .contains(
                                                  ...
                                                  ElevatedButton(
                                                      onPressed: (isSessionAvailable && _nextSessionData != null && _nextSessionData!.typeId != 99 && !_isFetchingTestGroup)
                                                          ? _startSession
                                                          : null,
                                                      ...
                                                      child: Text('لنبدأ',
                                                          style: TextStyle(
                                                              color: (isSessionAvailable && _nextSessionData != null && _nextSessionData!.typeId != 99 && !_isFetchingTestGroup)
                                                                  ? primaryBlue
                        ...
                        children: [
                          Expanded(
                              child: _buildAssessmentCard(
                                  ...
                                  onPressed: _isFetchingTestGroup
                                      ? null
                                      : () {
                                          Navigator.push(
                                              context,
